...
/**
 * Send notification to the voice notification server
 * Configure VOICE_SERVER_URL for your setup
 */
...
async function main() {
  ...
  // Send notification with voice (using assistant's voice - auto-detects language)
  const voiceId = getVoiceId(null, message); // null = main assistant

# PAI.md Template - Your Personal AI Identity

**Language:** [🇸🇪 Svenska](../sv/exempel-PAI-template.md) | 🇬🇧 English

---

## About PAI.md

**File:** `~/.claude/.claude/PAI.md`
**Purpose:** Your AI's core identity - read at every session start
**Format:** Markdown
**Who:** YOU! This is how Claude understands you and your PAI.
...
**Language:**
- Swedish: Natural communication, reflections
- English: Technical documentation, code, community sharing
- Mixed: OK during code discussions (Swedish text + English terms)
...
- Personal info: Only in local PAI, not in shared documentation
...
### 1. Copy Template
```bash
cp example-PAI-template.md ~/.claude/.claude/PAI.md
```

### 2. Fill In Your Details
Replace all `<PLACEHOLDER>` with your information:
- `<YOUR_NAME>`
- `<YOUR_PROFESSION>`
- `<VOICE_ID_XXX>`
- etc.
...
### 3. Enable Skills
Check [ ] for skills you have configured

### 4. Configure MCP
Check [ ] for MCP servers you have installed

### 5. Customize Tone & Language
Describe how you want Claude to communicate

---

## Tips

**Make PAI.md Personal:**
...
**Update Regularly:**
- Add new projects
- Update goals and vision
- Document important decisions

**Version Control:**
- Consider version controlling PAI.md (private repo)
- Or save backups regularly
